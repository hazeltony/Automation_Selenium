...
public class Motorcycle {
	...
	public static void main(String[] args) {
		...
		dr.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
		  ...
		  WebElement bike=dr.findElement(By.xpath("//div[@class='main-navigation']//li[3]//a"));
		  bike.click();
			...
			dr.findElement(By.id("cylindercapacity")).sendKeys("100");
			...
			Select  seat = new Select(dr.findElement(By.id("numberofseatsmotorcycle")));
			seat.selectByValue("2");
